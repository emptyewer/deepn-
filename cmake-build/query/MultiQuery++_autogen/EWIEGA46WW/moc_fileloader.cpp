...
QT_MOC_LITERAL(1, 11, 18), // "fileLoadedInMemory"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12), // "mapDataReady"
QT_MOC_LITERAL(4, 44, 7), // "mapData"
QT_MOC_LITERAL(5, 52, 11), // "_getMapData"
QT_MOC_LITERAL(6, 64, 4) // "text"

    },
    "FileLoader\0fileLoadedInMemory\0\0"
    "mapDataReady\0mapData\0_getMapData\0text"
};
...
void FileLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mapDataReady((*reinterpret_cast< QVariantList(*)>(_a[1]))); break;
        case 2: _t->_getMapData((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileLoader::fileLoadedInMemory)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileLoader::*)(QVariantList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileLoader::mapDataReady)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileLoader::fileLoadedInMemory()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FileLoader::mapDataReady(QVariantList _t1)
{
